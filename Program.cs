...
BEGIN
    ...
    BEGIN
        ...
        SET @alterSql = N'ALTER TABLE dbo.Sanad DROP CONSTRAINT [CK_Sanad_SanadType];';
        EXEC sys.sp_executesql @alterSql;

        SET @alterSql = N'ALTER TABLE dbo.Sanad ADD CONSTRAINT [CK_Sanad_SanadType] CHECK ('
...
BEGIN
    ...
    (
        ...
        ProviderStatusText nvarchar(200) NULL,
        ErrorMessage nvarchar(500) NULL,
        LastStatusCheckedAt datetime2 NULL,
