        ...
        CancellationToken ct = default)
    {
        ...
        if (!string.IsNullOrWhiteSpace(search))
        {
            ...
            query = query.Where(x =>
                ...
                (value.Length <= 10 && int.TryParse(value, out var id) && x.Id == id));
        }
        ...
        return Ok(ApiResponse<object>.SuccessResult(new { page, pageSize, items = data }, "طرف‌حساب‌ها با موفقیت دریافت شدند."));
    }
