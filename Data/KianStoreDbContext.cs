        ...
        modelBuilder.Entity<Sanad>(entity =>
{
    ...
    entity.Property(x => x.SmsStatus).HasMaxLength(20);
    ...
    entity.Property(x => x.LastChange).IsRowVersion();
});
        ...
        modelBuilder.Entity<DiscountCode>(entity => { entity.HasKey(x => x.Id); entity.HasIndex(x => x.Code).IsUnique(); entity.HasIndex(x => new { x.Scope, x.PersonId, x.IsActive }); entity.HasIndex(x => new { x.IssuedForIdSal, x.IssuedForIdSanad }); entity.Property(x => x.Code).HasMaxLength(50).IsRequired(); entity.Property(x => x.Title).HasMaxLength(200); entity.Property(x => x.IssuedForIdSanad).HasMaxLength(10); entity.Property(x => x.Value).HasPrecision(18, 3); entity.Property(x => x.MaxDiscountAmount).HasPrecision(18, 3); entity.Property(x => x.StartDate).HasColumnType("datetime2"); entity.Property(x => x.EndDate).HasColumnType("datetime2"); entity.Property(x => x.Description).HasMaxLength(1000); entity.Property(x => x.CreatedAt).HasColumnType("datetime2"); });
        ...
        modelBuilder.Entity<SmsLog>(entity => { entity.HasKey(x => x.Id); entity.Property(x => x.IdSal); entity.Property(x => x.IdSanad).HasMaxLength(10); entity.Property(x => x.Mobile).HasMaxLength(70).IsRequired(); entity.Property(x => x.Message).HasMaxLength(1000).IsRequired(); entity.Property(x => x.Status).HasColumnType("int"); entity.Property(x => x.Provider).HasMaxLength(100); entity.Property(x => x.ProviderMessageId).HasMaxLength(100); entity.Property(x => x.ProviderStatusText).HasMaxLength(200); entity.Property(x => x.ErrorMessage).HasMaxLength(500); entity.Property(x => x.CreatedAt).HasColumnType("datetime2"); entity.Property(x => x.LastStatusCheckedAt).HasColumnType("datetime2"); entity.HasOne<SmsTemplate>().WithMany().HasForeignKey(x => x.TemplateId).OnDelete(DeleteBehavior.SetNull); entity.HasIndex(x => new { x.PersonId, x.CreatedAt }); entity.HasIndex(x => new { x.IdSal, x.IdSanad, x.CreatedAt }); entity.HasIndex(x => x.CreatedAt); });
    }
}
