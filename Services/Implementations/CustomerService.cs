...
public class CustomerService : ICustomerService
{
    ...
    public async Task<ApiResponse<CustomerResponse>> GetByMobileAsync(string mobile)
    {
        ...
        if (taraf == null)
        {
            return ApiResponse<CustomerResponse>.ErrorResult("CUSTOMER_NOT_FOUND", "مشتری با این شماره موبایل یافت نشد.");
        }
        ...
        return ApiResponse<CustomerResponse>.SuccessResult(response);
    }
    ...
    public async Task<ApiResponse<CustomerResponse>> CreateCustomerAsync(CreateCustomerRequest request)
    {
        ...
        {
            return ApiResponse<CustomerResponse>.ErrorResult("DUPLICATE_MOBILE", "این شماره موبایل قبلاً ثبت شده است.");
        }
        ...
        return ApiResponse<CustomerResponse>.SuccessResult(response, "مشتری با موفقیت ایجاد شد.");
    }
}
